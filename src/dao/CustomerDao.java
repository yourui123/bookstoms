...
public interface CustomerDao {
       @Select("SELECT * from customerinfo WHERE customercame = '#{customername}'  AND customerpwd = ''")
       CustomerInfo LoginByname(@Param("customername")String customername,@Param("customerpwd")String customerpwd);
       
       @Select("SELECT * from customerinfo WHERE customertel = '#{customertel}'  AND customerpwd = ''")
